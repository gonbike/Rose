...
public:
	...
	void widget_set_blit(const std::string& id, const image::tblit& blit);
	void widget_set_blits(const std::string& id, const std::vector<image::tblit>& blits);

	void refresh_report(int num, const reports::report& r);
	virtual void refresh_blits_report(std::vector<image::tblit>& blits, int num, const reports::report& r, gui2::twidget& widget) {}
	...
	void set_theme_report_blits(int num, const std::vector<image::tblit>& blits) const;
