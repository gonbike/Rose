...
public:
	...
	public:
		tclear_restrict_width_cell_size_lock()
			: original_(link_group_owner)
		{
			VALIDATE(!clear_restrict_width_cell_size, null_str);
			clear_restrict_width_cell_size = true;
		}
		~tclear_restrict_width_cell_size_lock()
		{
			clear_restrict_width_cell_size = false;
		}
...
public:
	virtual tpoint fill_placeable_width(const int width) { return tpoint(twidget::npos, twidget::npos); }
	/**
	 * Places the widget.
	 *
