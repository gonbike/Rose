...
public:
	static tscroll_container& container_from_content_grid(const twidget& widget);
...
protected:
	...
	void vertical_set_item_position(const unsigned item_position);
	void horizontal_set_item_position(const unsigned item_position);
