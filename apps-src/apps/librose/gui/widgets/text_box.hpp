...
public:
	...
	void calculate_integrate() override;
	...
	bool exist_selection() const { return selection_end_.x != twidget::npos; }
...
private:
	...
	int get_text_maximum_width() const override;
...
private:
	...
	void signal_handler_mouse_motion(
			const event::tevent event, bool& handled, const tpoint& coordinate, const tpoint& coordinate2);
	...
	void signal_handler_left_button_double_click(
			const event::tevent event, bool& halt);
