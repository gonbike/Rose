...
void tpassword_box::paste_selection() 
{
	pre_function();
	{
		tin_operator_lock lock(*this);
		ttext_box::paste_selection();
	}
	post_function();
}

void tpassword_box::set_maximum_chars(const size_t maximum_chars)
{
	pre_function();
	{
		tin_operator_lock lock(*this);
		ttext_box::set_maximum_chars(maximum_chars);
	}
	post_function();
}
