...
tbuilder_report::tbuilder_report(const config& cfg)
	...
	, gap(cfg["gap"].to_int() * twidget::hdpi_scale)
...
{
	treport* widget = new treport(multi_line, toggle, unit_definition, unit_width, unit_height, gap, segment_switch, fixed_cols);
