...
void tnew_theme::reload_theme(twindow& window, const int desire_at, const bool initial)
{
	...
	if (initial) {
		text_box->set_did_text_changed(boost::bind(&tnew_theme::did_id_changed, this, boost::ref(window), _1));
	...
	for (int tpl = 0; tpl < theme::color_tpls; tpl ++) {
		...
		if (initial) {
			text_box->set_did_text_changed(boost::bind(&tnew_theme::did_color_changed, this, boost::ref(window), _1, tpl, theme::normal));
		...
		if (initial) {
			text_box->set_did_text_changed(boost::bind(&tnew_theme::did_color_changed, this, boost::ref(window), _1, tpl, theme::disable));
			text_box->set_placeholder("alpha, red, green, blue");
		}
		text_box->set_active(desire_at != 0);
		...
		if (initial) {
			text_box->set_did_text_changed(boost::bind(&tnew_theme::did_color_changed, this, boost::ref(window), _1, tpl, theme::focus));
			text_box->set_placeholder("alpha, red, green, blue");
		}
		text_box->set_active(desire_at != 0);
		...
		if (initial) {
			text_box->set_did_text_changed(boost::bind(&tnew_theme::did_color_changed, this, boost::ref(window), _1, tpl, theme::placeholder));
			text_box->set_placeholder("alpha, red, green, blue");
		}
		text_box->set_active(desire_at != 0);
	}
	...
	if (initial) {
		text_box->set_did_text_changed(boost::bind(&tnew_theme::did_color_changed, this, boost::ref(window), _1, theme::default_tpl, theme::item_focus));
		text_box->set_placeholder("alpha, red, green, blue");
	}
	text_box->set_active(desire_at != 0);
	...
	if (initial) {
		text_box->set_did_text_changed(boost::bind(&tnew_theme::did_color_changed, this, boost::ref(window), _1, theme::default_tpl, theme::item_highlight));
		text_box->set_placeholder("alpha, red, green, blue");
	}
	text_box->set_active(desire_at != 0);
	...
	if (initial) {
		text_box->set_did_text_changed(boost::bind(&tnew_theme::did_color_changed, this, boost::ref(window), _1, theme::default_tpl, theme::menu_focus));
		text_box->set_placeholder("alpha, red, green, blue");
	}
	text_box->set_active(desire_at != 0);
...
bool tnew_theme::did_item_pre_change_report(treport& report, ttoggle_button& widget, ttoggle_button* previous)
{
	...
	const int previous_at = (int)previous->cookie();
